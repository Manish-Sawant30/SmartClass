...
<head>
    ...
    <title>SmartClass | Admin Login</title>
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-container animate-scale">
            ...
            <!-- Title (now below the logo) -->
            <h2 class="animate-fade-up delay-1">Admin Login</h2>
            ...
            <c:if test="${not empty success}">
                <div class="message success animate-fade-up delay-2">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Touch feedback for mobile (only scale transform, no ripple)
