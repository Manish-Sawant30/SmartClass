...
<head>
    ...
    <title>SmartClass | Teacher Login</title>
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-container animate-scale">
            ...
            <!-- Title -->
            <h2 class="animate-fade-up delay-1">Teacher Login</h2>
            ...
            <div class="links animate-fade-up delay-6">
                ...
                <div class="signup-link">
                    ...
                    <a href="${pageContext.request.contextPath}/teacher/signup">Register Here</a>
                </div>
