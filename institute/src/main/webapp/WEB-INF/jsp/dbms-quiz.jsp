...
<head>
  ...
  <title>Database Management System Quiz | EduEra</title>
...
<body>
  ...
  <script>
    const questions = [
      {
        ...
        options: ["Database Management System", "Data Business Management System", "Database Manipulation System", "Data Base Memory System"],
        correct: 0,
        explanation: "DBMS = Database Management System."
      },
      {
        question: "Which is NOT a type of database model?",
        options: ["Hierarchical", "Network", "Relational", "Linear"],
        correct: 3,
        explanation: "Linear is not a database model type."
      },
      {
        question: "What is a primary key?",
        options: ["Unique identifier for record", "Foreign key reference", "Index for sorting", "Constraint for validation"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Organizing data to reduce redundancy", "Increasing data size", "Adding indexes", "Creating backups"],
        correct: 0,
      ...
      },
      {
        ...
        correct: 2,
        explanation: "MySQL is a relational database, not NoSQL."
      },
      {
        question: "What does ACID stand for?",
        options: ["Atomicity, Consistency, Isolation, Durability", "Accuracy, Consistency, Integrity, Durability", "Atomicity, Consistency, Integrity, Durability", "Accuracy, Consistency, Isolation, Durability"],
        correct: 0,
        explanation: "ACID = Atomicity, Consistency, Isolation, Durability."
      },
      {
        question: "Which is used to combine rows from tables?",
        options: ["JOIN", "UNION", "MERGE", "COMBINE"],
        correct: 0,
        explanation: "JOIN combines rows from tables."
      },
      {
        question: "What is a foreign key?",
        options: ["Reference to primary key in another table", "Unique key", "Primary key", "Index key"],
        correct: 0,
        explanation: "Foreign key references primary key in another table."
      },
      {
        question: "Which normal form eliminates transitive dependency?",
        options: ["1NF", "2NF", "3NF", "BCNF"],
        correct: 2,
        explanation: "3NF eliminates transitive dependency."
      },
      {
        question: "What is SQL injection?",
        options: ["Security vulnerability", "Data insertion", "Query optimization", "Backup technique"],
        correct: 0,
        explanation: "SQL injection is a security vulnerability."
      },
      {
        question: "Which is a DML command?",
        options: ["SELECT", "INSERT", "UPDATE", "All of these"],
        correct: 3,
        explanation: "All are Data Manipulation Language commands."
      },
      {
        question: "What is indexing used for?",
        options: ["Faster data retrieval", "Data security", "Data backup", "Data validation"],
        correct: 0,
        explanation: "Indexing speeds up data retrieval."
      },
      {
        question: "Which is NOT a transaction property?",
        options: ["Atomicity", "Consistency", "Redundancy", "Durability"],
        correct: 2,
        explanation: "Redundancy is not an ACID property."
      },
      {
        question: "What is a view in database?",
        options: ["Virtual table", "Physical table", "Index", "Constraint"],
        correct: 0,
        explanation: "View is a virtual table based on query."
      },
      {
        question: "Which is used for pattern matching in SQL?",
        options: ["LIKE", "MATCH", "PATTERN", "SIMILAR"],
        correct: 0,
        explanation: "LIKE operator is used for pattern matching."
      },
      {
        question: "What is deadlock in databases?",
        options: ["Transactions waiting for each other", "Database crash", "Network failure", "Disk full"],
        correct: 0,
        explanation: "Deadlock occurs when transactions wait for each other."
      },
      {
        question: "Which is a DDL command?",
        options: ["CREATE", "ALTER", "DROP", "All of these"],
        correct: 3,
        explanation: "All are Data Definition Language commands."
      },
      {
        question: "What is data warehousing?",
        options: ["Collection of data for analysis", "Data backup", "Data migration", "Data encryption"],
        correct: 0,
        explanation: "Data warehouse stores data for analysis."
      },
      {
        question: "Which is used to group rows?",
      ...
      },
      {
        ...
        options: ["Online Transaction Processing", "Online Transaction Protocol", "Offline Transaction Processing", "Online Transaction Program"],
        correct: 0,
        explanation: "OLTP = Online Transaction Processing."
      },
      {
        question: "Which is NOT a join type?",
        options: ["INNER JOIN", "OUTER JOIN", "CROSS JOIN", "VERTICAL JOIN"],
        correct: 3,
        explanation: "Vertical Join is not a standard SQL join."
      },
      {
        question: "What is data mining?",
        options: ["Discovering patterns in data", "Storing data", "Backing up data", "Encrypting data"],
        correct: 0,
        explanation: "Data mining discovers patterns in large datasets."
      },
      {
        question: "Which ensures data integrity?",
        options: ["Constraints", "Indexes", "Views", "Triggers"],
        correct: 0,
        explanation: "Constraints ensure data integrity."
      },
      {
        question: "What is ETL?",
        options: ["Extract, Transform, Load", "Extract, Transfer, Load", "Extract, Transform, Link", "Extract, Transfer, Link"],
        correct: 0,
    ...
    function initQuiz() {
      ...
      updateStats();
      updateProgress();
      localStorage.setItem('currentQuiz', 'dbms');
    }
