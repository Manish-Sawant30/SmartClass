...
<head>
  ...
  <title>Computer Networks Quiz | EduEra</title>
...
<body>
  ...
  <script>
    const questions = [
      {
        ...
        options: ["Open Systems Interconnection", "Operating System Interface", "Open Source Interface", "Operating Systems Interconnection"],
        correct: 0,
        explanation: "OSI = Open Systems Interconnection model."
      },
      {
      ...
      },
      {
        ...
        correct: 0,
        explanation: "TCP is connection-oriented with reliability."
      },
      {
        question: "What does DNS stand for?",
        options: ["Domain Name System", "Domain Network Service", "Digital Name System", "Data Network Service"],
        correct: 0,
      ...
      },
      {
        ...
        correct: 0,
        explanation: "Switch operates at Data Link layer (Layer 2)."
      },
      {
        question: "What is IP address 127.0.0.1?",
        options: ["Localhost", "Broadcast", "Default gateway", "Public IP"],
        correct: 0,
        explanation: "127.0.0.1 is localhost/loopback address."
      },
      {
        question: "Which is NOT a network topology?",
        options: ["Star", "Bus", "Ring", "Cube"],
        correct: 3,
        explanation: "Cube is not a standard network topology."
      },
      {
        question: "What does HTTP stand for?",
        options: ["HyperText Transfer Protocol", "Hyper Transfer Text Protocol", "High Transfer Text Protocol", "HyperText Transmission Protocol"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Divide network into subnets", "Encrypt data", "Authenticate users", "Route packets"],
        correct: 0,
        explanation: "Subnet mask divides network into subnets."
      },
      {
        question: "Which is a private IP range?",
        options: ["192.168.x.x", "8.8.8.8", "172.217.x.x", "203.0.113.x"],
        correct: 0,
        explanation: "192.168.x.x is private IP range."
      },
      {
        question: "What does MAC address identify?",
        options: ["Network interface card", "IP address", "Computer name", "User account"],
        correct: 0,
        explanation: "MAC address identifies network interface card."
      },
      {
        question: "Which protocol resolves IP to MAC?",
        options: ["ARP", "RARP", "DNS", "DHCP"],
        correct: 0,
        explanation: "ARP resolves IP address to MAC address."
      },
      {
        question: "What is firewall used for?",
        options: ["Network security", "Speed up network", "Connect networks", "Assign IP addresses"],
        correct: 0,
        explanation: "Firewall provides network security."
      },
      {
        question: "Which is a wireless standard?",
        options: ["Wi-Fi", "Ethernet", "Fiber optic", "Coaxial"],
        correct: 0,
        explanation: "Wi-Fi is wireless networking standard."
      },
      {
      ...
      {
        question: "Which is NOT a TCP/IP layer?",
        options: ["Application", "Transport", "Internet", "Session"],
        correct: 3,
        explanation: "Session is OSI layer, not TCP/IP."
      },
      {
        question: "What is ping used for?",
        options: ["Test connectivity", "Transfer files", "Browse web", "Send email"],
        correct: 0,
      ...
      },
      {
        ...
        options: ["Assigns IP addresses automatically", "Translates domain names", "Secures network", "Routes packets"],
        correct: 0,
      ...
      },
      {
        ...
        correct: 0,
        explanation: "OSPF is a routing protocol."
      },
      {
        question: "What is bandwidth?",
        options: ["Maximum data transfer rate", "Network delay", "Packet loss", "Signal strength"],
        correct: 0,
        explanation: "Bandwidth is maximum data transfer rate."
      },
      {
        question: "Which protocol is for email?",
        options: ["SMTP", "FTP", "HTTP", "SSH"],
        correct: 0,
        explanation: "SMTP is for sending email."
      },
      {
        question: "What is latency?",
        options: ["Delay in network", "Data loss", "Bandwidth", "Throughput"],
        correct: 0,
    ...
    function initQuiz() {
      ...
      updateStats();
      updateProgress();
      localStorage.setItem('currentQuiz', 'networks');
    }
