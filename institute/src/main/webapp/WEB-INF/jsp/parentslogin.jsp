...
<head>
    ...
    <title>SmartClass | Parent Login</title>
    ...
    <style>
        ...
        * {
        ...
        .support-link {
            ...
            font-size: 14px;
            padding-top: 15px;
            border-top: 1px solid var(--extra-light-purple);
        }
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-container animate-scale">
            ...
            <!-- Title -->
            <h2 class="animate-fade-up delay-1">Parent Login</h2>
            ...
            <!-- Login Form -->
            <form action="${pageContext.request.contextPath}/parents/login" method="post">
                <div class="form-group animate-fade-up delay-3">
                    <div class="input-icon" id="userIcon">
            ...
            <div class="links animate-fade-up delay-6">
                <a href="${pageContext.request.contextPath}/parent/signup" class="link">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (passwordIcon && passwordInput) {
                passwordIcon.addEventListener('click', function() {
                    ...
                    if (icon) {
                        icon.className = type === 'password' ? 'fas fa-lock' : 'fas fa-eye';
                    }
                });
            }
            ...
            if (forgotPasswordLink) {
                forgotPasswordLink.addEventListener('click', function(e) {
                    e.preventDefault();
                    alert('Please contact the administration office to reset your password.\nEmail: admin@smartclass.com\nPhone: +1 (555) 123-4567');
                });
            }
            ...
            const links = document.querySelectorAll('a:not(#forgotPassword)');
            links.forEach(link => {
